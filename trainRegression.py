...
try: refinedobject = sys.argv[1]
except: refinedobject = 'Electron'

print('*'*5,'will refine', refinedobject, '*'*5)
...
VARIABLES = [
    ...
    ('RecElectron_jetPtRelv2_CLASS', ['log']),
    ('RecElectron_jetRelIso_CLASS', ['log']),
    #('RecElectron_mass_CLASS', []),
    ('RecElectron_miniPFRelIso_all_CLASS', ['log']),
    ('RecElectron_miniPFRelIso_chg_CLASS', ['log']),
